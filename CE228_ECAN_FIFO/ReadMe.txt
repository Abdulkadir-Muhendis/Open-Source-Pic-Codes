...
Transmitting multiple messages from ECAN1 and receiving it in ECAN2 FIFO
Transmitting multiple messages from ECAN2 and receiving it in ECAN1 FIFO
...
5. Reconfiguring the project for a different dsPIC24H device
6. Revision History
...
The device used is dsPIC24HJ256GP610
...
a. C:\Program Files\Microchip\MPLAB C30\support\gld
	...
	The following file is used in this project - dsPIC24HJ256GP610.gld
...
4. Suggested Development Resources:
-----------------------------------
        a. Explorer 16 Demo board with dsPIC24HJ256GP610 controller
	b. ECAN PicTail Card 

5. Reconfiguring the project for a different dsPIC24H device:
-------------------------------------------------------------
The Project/Workspace can be easily reconfigured for any dsPIC24H device.
Please use the following general guidelines:
        a. Change device selection within MPLAB® IDE to a dsPIC24H device of
