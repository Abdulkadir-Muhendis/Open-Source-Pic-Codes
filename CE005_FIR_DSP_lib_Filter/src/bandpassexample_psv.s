; ..............................................................................
;    File   bandpassexample_psv.s
; ..............................................................................

                .equ bandpassexample_psvNumTaps, 123

; ..............................................................................
; Allocate and initialize filter taps

;               .section .bandpassexample_psvconst, "x" ;<-Syntax supported in MPLAB C30
                                                ;v1.20 and before
                .section .bandpassexample_psvconst, code ;<-Syntax supported in MPLAB C30
                                                ;v1.30 and later
                .align 256

bandpassexample_psvTaps:
...
bandpassexample_psvDelay:
                .space bandpassexample_psvNumTaps*2

; ..............................................................................
; Allocate and intialize filter structure

                .section .data
                .global _bandpassexample_psvFilter

_bandpassexample_psvFilter:
.hword bandpassexample_psvNumTaps
.hword psvoffset(bandpassexample_psvTaps)
.hword psvoffset(bandpassexample_psvTaps)+bandpassexample_psvNumTaps*2-1
.hword psvpage(bandpassexample_psvTaps)
.hword bandpassexample_psvDelay
.hword bandpassexample_psvDelay+bandpassexample_psvNumTaps*2-1
.hword bandpassexample_psvDelay
...
;               .extern _bandpassexample_psvFilter
;
;               .section        .bss
;
...
; output samples.
;               mov     #_bandpassexample_psvFilter, W0 ; Initalize W0 to filter structure
